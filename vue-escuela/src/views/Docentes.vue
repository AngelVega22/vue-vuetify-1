    ...
    <v-layout align-center justify-center wrap>
      <v-flex xs12 lg10 yapaycolor--text>
        ...
        <v-layout wrap>
          <!--=========================================================-->
          <v-flex
            v-for="marketingDocente in marketingDocentes"
            :key="marketingDocente.id"
            xs12
            sm4
            md3
            lg3
        ...
        <v-layout wrap>
          <!--=========================================================-->
          <v-flex
            v-for="fotografiaDocente in fotografiaDocentes"
            :key="fotografiaDocente.id"
            xs12
            sm4
            md3
            lg3
        ...
        <v-layout wrap>
          <!--=========================================================-->
          <v-flex
            v-for="diseñoDocente in diseñoDocentes"
            :key="diseñoDocente.id"
            xs12
            sm4
            md3
            lg3
        ...
        <v-layout wrap>
          <!--=========================================================-->
          <v-flex
            v-for="webDocente in webDocentes"
            :key="webDocente.id"
            xs12
            sm4
            md3
        ...
        <v-layout wrap>
          <!--=========================================================-->
          <v-flex
            v-for="coachDocente in coachDocentes"
            :key="coachDocente.id"
            xs12
            sm4
            md3
